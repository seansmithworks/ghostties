...
struct AgentSessionTests {
    ...
    @Test func sessionInitStoresAllFields() {
        ...
        let projectId = UUID()
        let lastActiveAt = Date(timeIntervalSince1970: 1_700_000_000)
        let lastOutputAt = Date(timeIntervalSince1970: 1_700_000_500)
        ...
        #expect(session.lastActiveAt == lastActiveAt)
        #expect(session.lastOutputAt == lastOutputAt)
    }
    ...
    @Test func sessionCodableRoundTrip() throws {
        ...
        #expect(decoded.lastOutputAt == original.lastOutputAt)
    }
